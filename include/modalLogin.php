                ...
                <div class="container">
                    <div class="modal-body">
                        <form action="logado.php" method="post">
                            <label>Nome</label>
                            <input type="text" class="form-control" name="email" placeholder="Digite seu Email:"> <br>

                            <label>Senha</label>
                            <input type="text" class="form-control" name="senha" placeholder="Informe sua Senha:"> <br>
