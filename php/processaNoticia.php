...
if ($imagem["name"]) {
    ...
    if ($imagem["size"] > $tamanho) {
        ...
        $sql = "INSERT INTO noticia (titulo, subtitulo, assunto, foto) 
                VALUES ('$titulo', '$subtitulo', '$assunto', '$nome_imagem' )";
        ...
        if ($upa) { ?>
            <script>
                ...
                location.href = '../inde.php'; //e redireciono o usuario para a pagina inicial, se quiserem mandar pra listagem fiquem a vontade
            </script>
        <?php
        } else { ?>
            <script>
